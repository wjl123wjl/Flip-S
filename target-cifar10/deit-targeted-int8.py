...
from utils.metrics import cifar10_acc, cifar10_asr
...
def main():
    ...
    save_path = "../data/cifar10/"+model_name.split('/')[-1]+"-cifar10.pkl"
    ...
    print('========================Before Attack========================')
    acc1 = cifar10_acc(torch.nn.Sequential(normalize, model), small_val_loader, device)
